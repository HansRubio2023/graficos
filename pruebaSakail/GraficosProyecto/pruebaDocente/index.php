...
<head>
    ...
    <title>Gráfico Docente</title>
</head>
<header>
    <nav>
        <ul>
            <li>
                <img src="sello_unaponline_blanco_1.webp" alt="Logo UNAP Online" width="25%" height="auto"> 
                <input type="button" value="Volver" title="Volver atrás" style="height: 30px;"> 
            </li>
        </ul>
    </nav>
</header>
...
<br><br>
    <h3 style='text-align: center;'>Porcentaje de Avance Semanal en Aula Virtual Online % 
        ...
        title="Este reporte muestra el avance en la lectura de los contenidos de los estudiantes durante cada semana."></i></h3>
    <div class="container">
        ...
        datos.forEach((item, indice) => {
            ...
            const animarBarra = () => {
                if (anchoBarra < anchoBarras) {
                    ...
                    contexto.font = 'bold 15.6px Segoe UI, sans-serif'; 
            ...
            contexto.font = '15.6px Segoe UI, sans-serif'; 
            contexto.textAlign = 'right';
            contexto.textBaseline = 'middle';
